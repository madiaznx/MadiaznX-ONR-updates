...
const DBF_FIELDS = [
  ...
  { name: 'CONF_MAT', type: 'C', size: 180 },
  { name: 'CONF_NOM', type: 'C', size: 220 },
  { name: 'REL_JUR', type: 'C', size: 80 },
  { name: 'DAT_INI', type: 'C', size: 10 },
  { name: 'DAT_FIM', type: 'C', size: 10 },
  { name: 'PER_REL', type: 'N', size: 12, decimals: 4 },
  { name: 'NOME_IMO', type: 'C', size: 160 },
  { name: 'AREA_HA', type: 'N', size: 18, decimals: 4 },
  { name: 'AREA_M2', type: 'N', size: 18, decimals: 2 },
  { name: 'PERIM_M', type: 'N', size: 18, decimals: 2 },
  { name: 'PERIM_KM', type: 'N', size: 18, decimals: 4 },
